#!/usr/bin/env python3
"""PDF production document for Video 6 — Status Quo Bias / Default Effect."""
...
from build_status_quo_doc import BEATS
...
pdf_path = "/home/user/Claudeeee/Status_Quo_Production.pdf"
doc = SimpleDocTemplate(pdf_path, pagesize=landscape(A4),
                        leftMargin=10*mm, rightMargin=10*mm,
                        topMargin=12*mm, bottomMargin=12*mm)

flow = [
    Paragraph("CRAYON CAPITAL — CLONE SESSION · VIDEO 6", SUB),
    Spacer(1, 4),
    Paragraph("The Billion-Dollar Bet Your Bank Is Making Against You Right Now", H1),
    Spacer(1, 4),
