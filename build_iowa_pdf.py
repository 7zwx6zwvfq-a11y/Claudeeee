#!/usr/bin/env python3
"""PDF production document for Video 4 — Iowa Gambling Task / Damasio."""
...
from build_iowa_doc import BEATS, STYLE
...
pdf_path = "/home/user/Claudeeee/Iowa_Gambling_Production.pdf"
doc = SimpleDocTemplate(pdf_path, pagesize=landscape(A4),
                        leftMargin=10*mm, rightMargin=10*mm,
                        topMargin=12*mm, bottomMargin=12*mm)

flow = [
    Paragraph("CRAYON CAPITAL — CLONE SESSION · VIDEO 4", SUB),
    Spacer(1, 4),
    Paragraph("Why the Smartest People Make the Worst Financial Decisions", H1),
    Spacer(1, 4),
