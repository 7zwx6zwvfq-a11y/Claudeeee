#!/usr/bin/env python3
"""PDF version of Video 3 script: Why Poor People Make Bad Decisions."""
...
from build_bandwidth_script import SECTIONS, TITLE, SUBTITLE, LABEL
...
BEAT = ParagraphStyle('BEAT', parent=styles['Normal'], fontSize=10.5, leading=14,
                      spaceAfter=2)
...
pdf_path = "/home/user/Claudeeee/Bandwidth_Tax_SCRIPT.pdf"
...
flow.append(Paragraph(
    f"TOTAL: {total_beats} beats · ~{all_words} words · ~{round(all_words/140)} min",
    FOOT))
