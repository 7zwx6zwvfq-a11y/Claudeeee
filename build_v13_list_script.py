#!/usr/bin/env python3
"""
VIDEO LISTA — 5 Ways Your Brain Physically Rewires Itself to Stay Broke (Without Telling You)
...
SUBTITLE = "NEUROCENTS · VIDEO LISTA"
LABEL    = "SCRIPT (NARRATION)"

SECTIONS = [

    ("HOOK", [
        # IDENTITY BEAT — espectador se reconoce antes de hacer clic
...
def build_docx():
    ...
    path = "/home/user/Claudeeee/V_Lista_SCRIPT.docx"
    doc.save(path)
...
def build_pdf(all_lines, total_beats, word_count):
    ...
    pdf_path = "/home/user/Claudeeee/V_Lista_SCRIPT.pdf"
...
def build_elevenlabs_pdf(all_lines, word_count):
    ...
    pdf_path = "/home/user/Claudeeee/V_Lista_ELEVENLABS.pdf"
    doc = SimpleDocTemplate(pdf_path, pagesize=A4,
                            leftMargin=20*mm, rightMargin=20*mm,
                            topMargin=18*mm, bottomMargin=18*mm)

    flow = [
        Paragraph("NEUROCENTS · VIDEO LISTA", SUB),
        Spacer(1, 4),
        Paragraph(esc(TITLE), H1),
        Spacer(1, 4),
...
if __name__ == "__main__":
    ...
    print(f"\n✅ VIDEO LISTA — 3 documentos generados")
