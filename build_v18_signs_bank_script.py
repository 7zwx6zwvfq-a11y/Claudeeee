#!/usr/bin/env python3
"""
VIDEO 18 (BANCO — pendiente de producción) — 7 SIGNS
...
SUBTITLE = "NEUROCENTS · VIDEO 18 (BANCO) — 7 SIGNS"
...
SECTIONS = [
    ...
    ("CTA", [
        ...
        "Every Thursday we drag one of these patterns into the light. It's free — and your brain will vote against it, which is how you know it works.",  # B36
    ]),
    ...
    ("CLOSE — THE CATCH", [
        ...
        "Seven signs. One count. And a program that just lost its anonymity.",  # B89
    ...
    ("NEXT VIDEO TEASE", [
        ...
        "Next week: the exact year money stopped hurting — when spending turned invisible, and what that did to your brain.",  # B92 tease V19 (Formato 6 Cronología)
        "A story that starts with coins you could feel and ends with a number you flinch at.",  # B93
...
def build_docx():
    ...
    path = "/home/user/Claudeeee/V18_bank_SCRIPT.docx"
    doc.save(path)
...
def build_pdf(all_lines, total, wc):
    ...
    pdf_path = "/home/user/Claudeeee/V18_bank_SCRIPT.pdf"
...
def build_elevenlabs_pdf(all_lines, wc):
    ...
    pdf_path = "/home/user/Claudeeee/V18_bank_ELEVENLABS.pdf"
    doc = SimpleDocTemplate(pdf_path, pagesize=A4,
                            leftMargin=20*mm, rightMargin=20*mm,
                            topMargin=18*mm, bottomMargin=18*mm)
    flow = [
        Paragraph("NEUROCENTS · VIDEO 18 (BANCO)", SUB),
        Spacer(1, 4),
        Paragraph(esc(TITLE), H1),
        Spacer(1, 4),
