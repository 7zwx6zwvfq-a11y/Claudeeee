#!/usr/bin/env python3
"""PDF production document for Video 5 — Mental Accounting / Thaler."""
...
from build_mental_accounting_doc import BEATS, STYLE
...
pdf_path = "/home/user/Claudeeee/Mental_Accounting_Production.pdf"
doc = SimpleDocTemplate(pdf_path, pagesize=landscape(A4),
                        leftMargin=10*mm, rightMargin=10*mm,
                        topMargin=12*mm, bottomMargin=12*mm)

flow = [
    Paragraph("CRAYON CAPITAL — CLONE SESSION · VIDEO 5", SUB),
    Spacer(1, 4),
    Paragraph("Why Free Money Is the Most Expensive Money You Own", H1),
    Spacer(1, 4),
