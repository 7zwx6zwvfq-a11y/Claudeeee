#!/usr/bin/env python3
"""PDF production document for Video 10 — Sunk Cost Fallacy."""
...
from build_sunk_cost_doc import BEATS
...
pdf_path = "/home/user/Claudeeee/Sunk_Cost_Production.pdf"
doc = SimpleDocTemplate(pdf_path, pagesize=landscape(A4),
                        leftMargin=10*mm, rightMargin=10*mm,
                        topMargin=12*mm, bottomMargin=12*mm)

flow = [
    Paragraph("CRAYON CAPITAL — CLONE SESSION · VIDEO 10", SUB),
    Spacer(1, 4),
    Paragraph("Your Brain Won't Let You Quit — And It's Costing You Everything", H1),
    Spacer(1, 4),
