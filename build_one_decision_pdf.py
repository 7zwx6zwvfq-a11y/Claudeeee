#!/usr/bin/env python3
"""PDF production document for Video 12 — The One Decision That Defeats All Three Brain Traps."""
...
from build_one_decision_doc import BEATS, STYLE, SECTION_STARTS
...
pdf_path = "/home/user/Claudeeee/One_Decision_Production.pdf"
doc = SimpleDocTemplate(pdf_path, pagesize=landscape(A4),
                        leftMargin=10*mm, rightMargin=10*mm,
                        topMargin=12*mm, bottomMargin=12*mm)

flow = [
    Paragraph("CRAYON CAPITAL — CLONE SESSION · VIDEO 12", SUB),
    Spacer(1, 4),
...
flow.append(Paragraph(
    f"END · {total_beats} beats · ~{word_count} words · ~{round(word_count/140)} min", META))
