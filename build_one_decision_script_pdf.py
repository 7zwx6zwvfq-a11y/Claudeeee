#!/usr/bin/env python3
"""Script PDF for Video 12 — The One Decision That Defeats All Three Brain Traps."""
...
from build_one_decision_script import SECTIONS, TITLE, SUBTITLE, LABEL
...
LINE = ParagraphStyle('LINE', parent=styles['Normal'], fontSize=11, leading=17,
                      spaceAfter=1)
NUM  = ParagraphStyle('NUM',  parent=styles['Normal'], fontSize=9,  leading=17,
...
pdf_path = "/home/user/Claudeeee/One_Decision_SCRIPT.pdf"
