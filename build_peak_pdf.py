#!/usr/bin/env python3
"""PDF production document for Video 7 — Availability Heuristic / Peak Buying."""
...
from build_peak_doc import BEATS
...
pdf_path = "/home/user/Claudeeee/Peak_Production.pdf"
doc = SimpleDocTemplate(pdf_path, pagesize=landscape(A4),
                        leftMargin=10*mm, rightMargin=10*mm,
                        topMargin=12*mm, bottomMargin=12*mm)

flow = [
    Paragraph("CRAYON CAPITAL — CLONE SESSION · VIDEO 7", SUB),
    Spacer(1, 4),
    Paragraph("Someone Needs You to Buy at the Top. Here's Who.", H1),
    Spacer(1, 4),
