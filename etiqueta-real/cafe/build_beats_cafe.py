...
TARGET_SECONDS = int(4249/174*60)  # duracion natural del guion a 174ppm
...
SECTION_SHOTS = {
    ...
    "MARCA 10 - BONKA": ["instant_coffee_jar", "generic_shelf", "network_anim", "aisle_dolly",
                          "cert_stamp", "reading_label_store"],
    "MARCA 9 - MARCILLA": ["vintage_factory", "instant_coffee_jar", "handshake_boardroom",
                             "world_map_network", "bar_chart_growth", "spain_flag1"],
    "MARCA 8 - SAIMAZA": ["vintage_factory", "spain_flag1", "handshake_boardroom",
                            "world_map_network", "aisle_dolly", "instant_coffee_jar"],
    "MARCA 7 - HACENDADO": ["coffee_beans_conveyor", "generic_shelf", "world_map_network",
                              "cert_stamp", "aisle_dolly", "coffee_beans_roasting"],
    "CTA SUTIL (~35%)": ["share_button_glow", "finger_share_phone", "youtube_share_anim"],
    "MARCA 6 - MARCA BLANCA": ["generic_shelf", "aisle_dolly", "sugar_cube_splash",
                                 "coffee_beans_drum_roaster", "magnifier_doc", "woman_browsing_shelves",
                                 "vintage_factory"],
    "MARCA 5 - NESCAFE": ["instant_coffee_pour_mug", "coffee_granules_pour_jar", "vintage_factory",
                            "cert_stamp", "world_map_network", "warning_icon"],
    "MARCA 4 - L'OR": ["coffee_capsule_machine", "espresso_pour_crema", "handshake_boardroom",
                         "bar_chart_growth", "coffee_cup_steam"],
    "MARCA 3 - BUSTELO Y PILON": ["vintage_factory", "cans_aligned_low", "handshake_boardroom",
                                    "generic_shelf", "aisle_dolly", "reading_label_store"],
    "MARCA 2 - COLCAFE": ["colombia_flag", "coffee_farmer_picking", "network_anim",
                            "world_map_network", "bar_chart_growth", "handshake_boardroom"],
    "MARCA 1 - DESCAFEINADO QUIMICO": ["magnifier_doc", "warning_icon", "kitchen_scale",
                                         "coffee_beans_falling_pile", "coffee_cup_steam", "cert_stamp"],
    "MEJORES - INTRO": ["share_button_glow", "finger_share_phone"],
    "MEJOR 5 - ESPECIALIDAD": ["coffee_shop_specialty", "coffee_beans_falling_pile", "cert_stamp",
                                 "barista_espresso"],
    "MEJOR 4 - SWISS WATER": ["moka_pot_beans", "kitchen_scale", "coffee_cup_steam", "cert_stamp"],
    "MEJOR 3 - LAVAZZA TIERRA": ["coffee_farmer_picking", "cert_stamp", "world_map_network",
                                   "bar_chart_growth"],
    "MEJOR 2 - PROFECO MEXICO": ["mexico_flag", "magnifier_doc", "kitchen_scale", "cert_stamp"],
    "MEJOR 1 - JUAN VALDEZ": ["colombia_flag", "coffee_farmer_picking", "barista_espresso",
                                "handshake_boardroom", "cert_stamp"],
