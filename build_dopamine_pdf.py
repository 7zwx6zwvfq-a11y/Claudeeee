#!/usr/bin/env python3
"""Render the same beat data to PDF via reportlab (LibreOffice is broken here)."""
...
from build_dopamine_doc import BEATS, STYLE  # reuse the single source of truth
...
pdf_path = "/home/user/Claudeeee/Dopamine_Trap_Production.pdf"
doc = SimpleDocTemplate(pdf_path, pagesize=A4,
                        leftMargin=15*mm, rightMargin=15*mm,
                        topMargin=15*mm, bottomMargin=15*mm)
flow = []
flow.append(Paragraph("CRAYON CAPITAL — CLONE SESSION · VIDEO 2", H1))
flow.append(Spacer(1, 4))
flow.append(Paragraph('"Por qué comprar se siente mejor que tener" &nbsp;·&nbsp; '
                      'The Dopamine Trap', SUB))
flow.append(Spacer(1, 4))
flow.append(Paragraph("Neuroeconomía · Inglés · Target 1,700 · Final 1,724 words · "
